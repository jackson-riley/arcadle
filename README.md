...
> Use pre-generated blurred images (`/public/screenshots/.../blur-0.jpg` ..
> `blur-5.jpg`) for each reveal stage (generated by `scripts/generate-blurs.ts`), and
> use `solved.jpg` once the puzzle is complete."
