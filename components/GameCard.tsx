 ...
 *   2. If screenshots exist on disk, render an <img> using pre-generated
 *      `/public/screenshots/<slug>/blur-{0..5}.jpg` and `/solved.jpg`
 *   3. Blur levels are generated by `scripts/generate-blurs.ts` (sharp) and
 *      correspond to reveal stages 1–6 via `blur-0`..`blur-5`
 *   4. In production, serve only the pre-generated blurred images
 *      (prevents devtools from revealing the original)
 */
